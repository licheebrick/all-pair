...
void Rulebased::set_new_rule(string list_str, std::list<int>* tmp_list, uint64_t rule)
{
    std::map<uint32_t, std::map<std::list<int>*, std::set<uint64_t>* >* >::iterator it;
    ...
    {
        std::map<std::list<int>*, std::set<uint64_t>* >* new_map;
        new_map = new std::map<std::list<int>*, std::set<uint64_t>* >;
...
void Rulebased::print_rule_map()
{
    ...
    {
        std::map<std::list<int>*, std::set<uint64_t>* > tmp = *it->second;
        std::map<std::list<int>*, std::set<uint64_t>* >::iterator iter;
